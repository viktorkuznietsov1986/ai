...
import vacuumworld.agents.SimpleWorldStateReflexAgent;
 ...
 */
public class SimpleWorldStateReflexAgentRunner implements SimulationRunner {
    /**
     * Runs the simulation.
     */
    @Override
    public void run() {
        ...
        for (int i = 0; i < 2; ++i) {
            ...
            Agent agent = new SimpleWorldStateReflexAgent(cleaner);
